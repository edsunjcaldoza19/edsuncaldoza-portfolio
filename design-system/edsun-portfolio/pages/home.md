...
- Show three equal cards when a desktop category has exactly three projects. For longer desktop categories, show three full cards plus roughly 40% of the next card. Show exactly two cards from 768px to 1024px and exactly one card below 768px, with the remaining projects available through dragging, swiping, keyboard controls, or navigation buttons.
