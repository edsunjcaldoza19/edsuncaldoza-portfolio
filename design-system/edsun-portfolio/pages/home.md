...
- Feature six selected projects in a two-column desktop grid and one column on mobile. Link each project image, title, and “View Project” action to its matching Behance gallery.
