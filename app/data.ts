...
export const projects: Project[] = [
  {
    ...
    kicker: "Web Design",
    summary: "See how a detailed AI business offer becomes a clear sales page that guides visitors from interest to action.",
  ...
  },
  {
    ...
    categoryId: "web-design",
    kicker: "Web Design",
    summary: "See how a long AI income offer can stay easy to scan from the first benefit to the final call to action.",
  ...
  },
  {
    ...
    summary: "See how one campaign system can make a detailed digital marketing topic easier to follow across webinar and social content.",
  ...
  },
  {
    ...
    summary: "Explore a slide system that helps presenters guide audiences through financial lessons, examples, and activities.",
  ...
  },
  {
    ...
    categoryId: "webinar-presentations",
    kicker: "Presentation Design",
    summary: "Explore a webinar slide system that makes financial decisions feel clear, practical, and approachable.",
  ...
  },
  {
    ...
    categoryId: "webinar-presentations",
    kicker: "Presentation Design",
    summary: "Explore a webinar template that turns digital marketing topics into a teaching flow your audience can follow.",
  ...
  },
  {
    ...
    summary: "Explore a flexible blue deck that keeps webinar content, speakers, and audience prompts clear from one topic to the next.",
  ...
  },
  {
    ...
    categoryId: "webinar-presentations",
    kicker: "Google Slides Design",
    summary: "See how a high-energy webinar deck can keep social media marketing lessons clear, engaging, and easy to present.",
  ...
  },
  {
    ...
    categoryId: "webinar-presentations",
    kicker: "Presentation Design",
    summary: "Explore a financial webinar deck that gives income-building lessons, speaker content, and discussion prompts a clear order.",
  ...
  },
  {
    ...
    categoryId: "web-design",
    kicker: "UI/UX Design",
    summary: "See how a reading app can take people from discovery to a calm, focused reading experience.",
  ...
  },
  {
    ...
    summary: "See how a health book cover can feel trustworthy and easy to recognize at a glance, in print or at thumbnail size.",
  ...
  },
  {
    ...
    categoryId: "graphic-design",
    kicker: "Print Design",
    summary: "See how a compact brochure can make rental choices, service details, and booking information easy to find.",
  ...
  },
  {
    ...
    summary: "Watch how a focused CapCut tutorial can turn export settings into a clear checklist for crisp video.",
  ...
  },
  {
    ...
    categoryId: "video-editing",
    kicker: "Video Editing",
    summary: "Watch how a CapCut tutorial can help creators avoid watermarks without sacrificing video quality.",
  ...
  },
  {
    ...
    categoryId: "video-editing",
    kicker: "Video Editing",
    summary: "Watch how a CapCut tutorial can turn a blank canvas into a clear cover or thumbnail that catches attention.",
...
export const workCategories: readonly WorkCategory[] = [
  {
    ...
    description: "See how I turn ideas into clear graphics, covers, and campaign pieces.",
  ...
  },
  {
    ...
    description: "Explore slide systems that help people follow the story and stay engaged.",
  ...
  },
  {
    ...
    number: "03",
    title: "Web Design",
    description: "See how I organize content into pages and interfaces that guide the next step.",
  ...
  },
  {
    ...
    number: "04",
    title: "Video Editing",
    description: "Watch tutorials and edits built to keep each idea clear and moving.",
